...
tl.from(".intro-head2", {y: -50, opacity: 0, duration: 0.4, ease: "Expo.easeInOut" });
tl.from(".project-cont", {x: 300, opacity: 0, duration: 0.4, stagger: 0.2, ease: "Expo.easeInOut"}, "-=0.2");
